...
cases = [case for case in os.listdir("data_virtual_hospital")]

categories_all = set()
for case in cases:
    print("Running case ", case)
    with open(f"data_virtual_hospital/{case}/modified/2_physician/plan.txt", "r") as f:
        plan_content = f.read()
...
# with open("plan_categories/categories_summary.txt", "w") as file:
#     for category in categories_all:
#         file.write(category + "\n")

    with open(f"plan_categories/each_case/{case}.txt", "w") as file:
